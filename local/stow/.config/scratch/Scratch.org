...
#+begin_src emacs-lisp :tangle (if (member this-system system-category-1) "~/.emacs.d/init.el" "no")
    ...
    (use-package dashboard
      ...
      (setq dashboard-init-info "The more you try the more you fail!")
  ...
  #+begin_src emacs-lisp :tangle (if (member this-system system-category-1) "~/.emacs.d/init.el" "no")
    ...
    ;; TODO: setup ivy keybinds
      (dw/leader-key-def
        ...
        "p."  '(counsel-projectile-find-file           :which-key "Find file in project")
        "p!"  '(projectile-run-shell-command-in-root   :which-key "Run cmd in project root")
        "pa"  '(counsel-projectile-ag                  :which-key "Search project with ag")
        "pr"  '(counsel-projectile-rg                  :which-key "Search project with rg")
